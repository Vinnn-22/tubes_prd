...
class FilledTambahProdukDetailScreen extends StatefulWidget {
  const FilledTambahProdukDetailScreen({super.key});

  @override
  State<FilledTambahProdukDetailScreen> createState() => _FilledTambahProdukDetailScreenState();
}

class _FilledTambahProdukDetailScreenState extends State<FilledTambahProdukDetailScreen> {
  final TextEditingController namaController = TextEditingController(text: 'Wortel Bekasi');
  final TextEditingController deskripsiController = TextEditingController(text: 'Deskripsi produk');
  final TextEditingController kuantitasController = TextEditingController(text: '1');
  final TextEditingController tanggalPanenController = TextEditingController(text: '02/06/2025');
  final TextEditingController hariController = TextEditingController(text: '30');
  final TextEditingController bulanController = TextEditingController(text: '0');
  final TextEditingController tahunController = TextEditingController(text: '0');
  
  // New stock fields
  final TextEditingController sisaStokController = TextEditingController(text: '10');
  final TextEditingController tambahStokController = TextEditingController(text: '0');
  
  String selectedCategory = 'Sayur';
  bool isPenyimpananDropdownOpen = false;
  List<String> selectedPenyimpanan = ['Lemari pendingin'];
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // Image picker section with tomato image
                  Align(
                  ...
                  // Stock section (Sisa Stok and Tambah Stok) - NEW
                  Text(
                    'Stok Tersisa',
                    style: TextStyle(
                      fontSize: 16,
